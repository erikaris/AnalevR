...
from flask import current_app, make_response, request, _request_ctx_stack, Response as FlaskResponse
...
class Response(FlaskResponse):
    def __init__(self, success=True, message="", data="", response=None, status=None,
        ...
        FlaskResponse.__init__(self, response, status, headers, mimetype, content_type, direct_passthrough)